...
def чужие_слова(text):
    ...
    широком кольце, потом как гранёный купол в узком витом ободке — оба описания неверны: в
    слоте 3 лежит кованое золото самородком, гранёная середина и неровный битый ободок. Из
    этого вырос ложный закон C6 «рисунок пуговицы не лечится» (Ф144, снят в Ф171). Обувь в слоте 7 сменилась с
