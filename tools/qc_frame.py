...
def main():
    ...
    # насечками», тогда как на слоте 3 гранёный купол в узком витом ободке (Ф144).
    print('Далее глазами: три пуговицы и ни одной больше, рисунок пуговицы — ГРАНЁНЫЙ купол в')
    print('узком витом ободке, как в паспорте изделия (папка refs/approved), V-вырез, нет полосы')
    print('по низу и манжетам, низ перекрывает верх кармана джинсов, карманов на кардигане нет.\n')
